...
public class blue_auton_cam_long extends LinearOpMode {
    /* =============== camera variables  ===============*/
...
//
        ...
        TrajectorySequence right_spike = drive.trajectorySequenceBuilder(startPose)
                .splineTo(new Vector2d(-40.00, -41), Math.toRadians(-20.00))
                .build();
        ...
        TrajectorySequence right_board = drive.trajectorySequenceBuilder(right_deposit_back.end())
                .lineToLinearHeading(new Pose2d(-44.00, -36, Math.toRadians(0.00)))
                .forward(34)
                .turn(90)
                .splineTo(new Vector2d(-15.62, 11.18), Math.toRadians(110.43))
                .splineTo(new Vector2d(-26, 49.00), Math.toRadians(90.00))
                .forward(3)
                .build();
        ...
        Trajectory middle_spike = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-37.00, -38, Math.toRadians(20)))
                .build();
        ...
        TrajectorySequence middle_board = drive.trajectorySequenceBuilder(middle_deposit_back.end())
                .lineToLinearHeading(new Pose2d(-37, -55, Math.toRadians(0.00)))
                .lineToLinearHeading(new Pose2d(-10, -55, Math.toRadians(90.00)))
                .splineTo(new Vector2d(-15.62, 11.18), Math.toRadians(110.43))
                .splineTo(new Vector2d(-30, 49.00), Math.toRadians(90.00))
                .forward(5)
                .build();
        ...
        TrajectorySequence left_spike = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-36, -36, Math.toRadians(90)),SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
        ...
        TrajectorySequence left_board = drive.trajectorySequenceBuilder(left_deposit_back.end())
                .lineToLinearHeading(new Pose2d(-10, -36, Math.toRadians(90.00)))
                .splineTo(new Vector2d(-15.62, 11.18), Math.toRadians(110.43))
                .splineTo(new Vector2d(-33.00, 49.00), Math.toRadians(90.00))
                .forward(7)
                .build();
