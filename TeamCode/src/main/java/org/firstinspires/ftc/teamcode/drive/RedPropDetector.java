...
public class RedPropDetector extends OpenCvPipeline {
    ...
    private int m_whichSide = 2; // 1=left, 2=right (default to be the left side)
    private final double zoneRange_topFilter = 0.45;
    private double m_zoneRange_split_leftSide = 0.36; // split it to left and right zones
    private double m_zoneRange_split_rightSide = 0.4; // split it to left and right zones
